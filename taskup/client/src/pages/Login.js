...
const registerSchema = Yup.object().shape({
  ...
  email: Yup.string().email("Хүчингүй").required("Required"),
        ...
        <Box p="2rem 0" m="2rem auto" width={isNotMobile ? "50%" : "90%"}>
          ...
          <form onSubmit={handleSubmit}>
            <Box display="flex" flexDirection="column" gap="30px">
                  ...
                  >
                    {({ getRootProps, getInputProps }) => (
                      ...
                      >
                        <input {...getInputProps()} />
                        {!values.picture ? (
                          <Typography>Зураг оруулах</Typography>
                        ) : (
                          <Typography>
              ...
              >
                {isLogin ? (
                  <>Бүртгэл байхгүй, Бүртгэх хэсэгт шилжих</>
                ) : (
                  <>Бүртгэлтэй, Нэвтрэх хэсэгт шилжих</>
                )}
              </Typography>
            </Box>
          </form>
